...
test('it converts reducer arrays correctly', () => {
  ...
  expect(Object.keys(logic.reducers).sort()).toEqual(['everything', 'noOptions', 'noProp', 'noPropNoOptions'])
  expect(Object.keys(logic.defaults).sort()).toEqual(['everything', 'milk', 'noOptions', 'noProp', 'noPropNoOptions'])
