...
var Logic = function () {
  ...
  _createClass(Logic, [{
    ...
    value: function init() {
      ...
      object.structure = (0, _structure.convertStructureArrays)(this.structure(object));
      ...
      var response = this.selectors(_extends({}, object, { addSelector: this.addSelector.bind(object) }));
